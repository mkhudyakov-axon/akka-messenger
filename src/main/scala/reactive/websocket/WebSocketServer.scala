...
@SerialVersionUID(1L)
class WebSocketServer(val serverConnection: ActorRef, val route: Route) extends RouteActor with WebSocketServerWorker with WebSocket with Serializable {
  ...
  override def businessLogic = {
    ...
    case UpgradedToWebSocket => // nothing to do
