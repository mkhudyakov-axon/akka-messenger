...
/* check out how to prepare a self-signed certificcate in your keystore at http://www.startux.de/index.php/java/44-dealing-with-java-keystoresyvComment44
   keytool -genkeypair -keyalg rsa -dname "CN=Alain Béarez, OU=TI, O=cuali, L=Fortaleza, ST=Ceará, C=BR" -keystore keystore.jks -storepass "Spray Easter Eggs" -alias "Spray Easter Eggs"
   keytool -certreq -alias "Spray Easter Eggs" -keystore keystore.jks -storepass "Spray Easter Eggs" -file eggs.csr
   keytool -gencert -infile eggs.csr -outfile eggs.cert -alias "Spray Easter Eggs" -keystore keystore.jks -storepass "Spray Easter Eggs" -validity 7777
   keytool -importcert -file eggs.cert -alias "Spray Easter Eggs" -keystore keystore.jks -storepass "Spray Easter Eggs" */
